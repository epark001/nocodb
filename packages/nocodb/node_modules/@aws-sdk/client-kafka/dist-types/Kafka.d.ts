...
export interface Kafka {
     ...
     */
    describeClusterOperationV2(args: DescribeClusterOperationV2CommandInput, options?: __HttpHandlerOptions): Promise<DescribeClusterOperationV2CommandOutput>;
    describeClusterOperationV2(args: DescribeClusterOperationV2CommandInput, cb: (err: any, data?: DescribeClusterOperationV2CommandOutput) => void): void;
    describeClusterOperationV2(args: DescribeClusterOperationV2CommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DescribeClusterOperationV2CommandOutput) => void): void;
    /**
     ...
     */
    listClusterOperationsV2(args: ListClusterOperationsV2CommandInput, options?: __HttpHandlerOptions): Promise<ListClusterOperationsV2CommandOutput>;
    listClusterOperationsV2(args: ListClusterOperationsV2CommandInput, cb: (err: any, data?: ListClusterOperationsV2CommandOutput) => void): void;
    listClusterOperationsV2(args: ListClusterOperationsV2CommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListClusterOperationsV2CommandOutput) => void): void;
    /**
