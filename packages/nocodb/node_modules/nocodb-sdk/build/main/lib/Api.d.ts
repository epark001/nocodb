...
export interface BaseType {
     ...
     * @example mysql2
     */
    type?: 'mssql' | 'mysql' | 'mysql2' | 'oracledb' | 'pg' | 'snowflake' | 'sqlite3';
}
/**
 * Model for Base List
 */
 ...
 * Model for Bool
 */
export declare type BoolType = number | boolean | null;
/**
 * Model for Column
 */
export interface ColumnType {
     ...
     */
    uidt?: 'Attachment' | 'AutoNumber' | 'Barcode' | 'Button' | 'Checkbox' | 'Collaborator' | 'Count' | 'CreateTime' | 'Currency' | 'Date' | 'DateTime' | 'Decimal' | 'Duration' | 'Email' | 'Formula' | 'ForeignKey' | 'GeoData' | 'Geometry' | 'ID' | 'JSON' | 'LastModifiedTime' | 'LongText' | 'LinkToAnotherRecord' | 'Lookup' | 'MultiSelect' | 'Number' | 'Percent' | 'PhoneNumber' | 'Rating' | 'Rollup' | 'SingleLineText' | 'SingleSelect' | 'SpecificDBType' | 'Time' | 'URL' | 'Year' | 'QrCode' | 'Links';
    /** Is Unsigned? */
    un?: BoolType;
    /** Is unique? */
    unique?: BoolType;
 ...
 */
export declare type ColumnReqType = (FormulaColumnReqType | LinkToAnotherColumnReqType | LookupColumnReqType | NormalColumnRequestType | RollupColumnReqType | (FormulaColumnReqType & LinkToAnotherColumnReqType & LookupColumnReqType & NormalColumnRequestType & RollupColumnReqType)) & {
    column_name?: string;
 ...
 * Model for Meta
 */
export declare type MetaType = null | object | string;
/**
...
export interface RollupType {
     ...
     * @example count
     */
    rollup_function?: 'count' | 'min' | 'max' | 'avg' | 'countDistinct' | 'sumDistinct' | 'avgDistinct';
}
/**
 ...
 */
export declare type SharedViewType = ViewType;
/**
 ...
 * Model for StringOrNull
 */
export declare type StringOrNullType = string | null;
/**
 * Model for Table
 */
...
export interface ViewType {
    ...
    view?: FormType | GalleryType | GridType | KanbanType | MapType | (FormType & GalleryType & GridType & KanbanType & MapType);
}
/**
 * Model for View List
 */
 ...
 */
export declare type VisibilityRuleReqType = {
    id?: string | null;
    disabled?: {
        /** Model for Bool */
        commenter?: BoolType;
...
export declare type NotificationType = {
    ...
    updated_at?: any;
    created_at?: any;
} & (ProjectInviteEventType | ProjectEventType | TableEventType | ViewEventType | ColumnEventType | WelcomeEventType | SortEventType | FilterEventType);
/**
...
export declare type RequestParams = Omit<FullRequestParams, 'body' | 'method' | 'path'>;
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
     ...
     */
        projectUserList: (projectId: IdType, params?: RequestParams) => Promise<{
            users?: {
                list: UserType[];
                /** Model for Paginated */
                pageInfo: PaginatedType;
     ...
     */
        projectUserAdd: (projectId: IdType, data: ProjectUserReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message for inviting single email
             * @example The user has been invited successfully
             */
     ...
     */
        projectUserUpdate: (projectId: IdType, userId: IdType, data: ProjectUserReqType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The user has been updated successfully
             */
     ...
     */
        projectUserRemove: (projectId: IdType, userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The user has been updated successfully
             */
     ...
     */
        projectUserResendInvite: (projectId: IdType, userId: IdType, params?: RequestParams) => Promise<{
            /**
             * Success Message
             * @example The invitation has been sent to the user
             */
     ...
     */
        delete: (token: string, params?: RequestParams) => Promise<number>;
    };
    orgLicense: {
        /**
     ...
     */
        metaGet: (projectId: IdType, params?: RequestParams) => Promise<{
            /**
             * Node version
             * @example v12.16.1
             */
     ...
     */
        modelVisibilityList: (projectId: IdType, query?: {
            includeM2M?: boolean;
     ...
     */
        modelVisibilitySet: (projectId: IdType, data: VisibilityRuleReqType, params?: RequestParams) => Promise<{
            /** @example UI ACL has been created successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        create: (data: ProjectReqType & {
            ...
            external?: boolean;
        }, params?: RequestParams) => Promise<ProjectType>;
        /**
     ...
     */
        baseDuplicate: (projectId: IdType, data: {
            options?: {
                excludeData?: boolean;
            ...
            project?: object;
        }, baseId?: IdType, params?: RequestParams) => Promise<{
            name?: string;
            id?: string;
            project_id?: string;
        }>;
     ...
     */
        duplicate: (projectId: IdType, data: {
            options?: {
                excludeData?: boolean;
                excludeViews?: boolean;
                excludeHooks?: boolean;
     ...
     */
        read: (projectId: IdType, params?: RequestParams) => Promise<ProjectType>;
        /**
     ...
     */
        delete: (projectId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        update: (projectId: IdType, data: ProjectUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
         * No description
         *
         * @tags Project
         ...
         * @response `200` `void` OK
         */
        userMetaUpdate: (projectId: string, data: ProjectUserMetaReqType, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        sharedBaseGet: (projectId: IdType, params?: RequestParams) => Promise<{
            /**
             * @format uuid
             * @example a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11
             */
     ...
     */
        sharedBaseDisable: (projectId: IdType, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        sharedBaseCreate: (projectId: IdType, data: SharedBaseReqType, params?: RequestParams) => Promise<{
            /** Model for StringOrNull */
            uuid?: StringOrNullType;
            /** Model for StringOrNull */
            roles?: StringOrNullType;
     ...
     */
        sharedBaseUpdate: (projectId: IdType, data: SharedBaseReqType, params?: RequestParams) => Promise<{
            /**
             * @format uuid
             * @example a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11
             */
     ...
     */
        cost: (projectId: IdType, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        metaDiffSync: (projectId: IdType, params?: RequestParams) => Promise<{
            /** @example The meta has been synchronized successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        metaDiffGet: (projectId: IdType, params?: RequestParams) => Promise<{
            /**
             * Table Name
             * @example Table 1
             */
     ...
     */
        hasEmptyOrNullFilters: (projectId: IdType, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        auditList: (projectId: IdType, query?: {
            /** @min 0 */
            offset?: number;
            /** @max 1 */
            limit?: number;
     ...
     */
        read: (projectId: IdType, baseId: string, params?: RequestParams) => Promise<BaseType>;
        /**
     ...
     */
        delete: (projectId: IdType, baseId: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        update: (projectId: IdType, baseId: string, data: object, params?: RequestParams) => Promise<object>;
        /**
         * No description
         *
         * @tags Base
         ...
         * @response `200` `object` OK
         */
        createSqlView: (projectId: string, baseId: string, data: {
            view_name?: string;
     ...
     */
        list: (projectId: IdType, params?: RequestParams) => Promise<BaseListType>;
        /**
     ...
     */
        create: (projectId: IdType, data: BaseType & {
            external?: boolean;
         ...
         * @response `200` `BaseType` OK
         */
        shareErd: (projectId: string, baseId: string, params?: RequestParams) => Promise<BaseType>;
        /**
         * No description
         *
         * @tags Base
         ...
         * @response `200` `void` OK
         */
        disableShareErd: (projectId: string, baseId: string, params?: RequestParams) => Promise<void>;
        /**
     ...
     */
        tableList: (projectId: IdType, baseId: string, query?: {
            page?: number;
            pageSize?: number;
            sort?: string;
            includeM2M?: boolean;
     ...
     */
        tableCreate: (projectId: IdType, baseId: string, data: TableReqType, params?: RequestParams) => Promise<TableType>;
        /**
     ...
     */
        metaDiffSync: (projectId: IdType, baseId: string, params?: RequestParams) => Promise<{
            /** @example The base meta has been synchronized successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        metaDiffGet: (projectId: IdType, baseId: string, params?: RequestParams) => Promise<{
            /**
             * Table Name
             * @example Table 1
             */
     ...
     */
        create: (projectId: IdType, data: TableReqType, params?: RequestParams) => Promise<TableType>;
        /**
     ...
     */
        duplicate: (projectId: IdType, tableId: IdType, data: {
            options?: {
                excludeData?: boolean;
                excludeViews?: boolean;
                excludeHooks?: boolean;
     ...
     */
        update: (viewId: string, data: SharedViewReqType, params?: RequestParams) => Promise<ViewType>;
        /**
     ...
     */
        read: (viewId: string, params?: RequestParams) => Promise<FilterListType>;
        /**
     ...
     */
        list: (orgs: string, projectName: string, tableName: string, query?: {
     ...
     */
        create: (orgs: string, projectName: string, tableName: string, data: object, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        findOne: (orgs: string, projectName: string, tableName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
        }, params?: RequestParams) => Promise<object>;
         ...
         * @response `200` `any` OK
         */
        groupBy: (orgs: string, projectName: string, tableName: string, query?: {
     ...
     */
        groupedDataList: (orgs: string, projectName: string, tableName: string, columnId: IdType, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
     ...
     */
        read: (orgs: string, projectName: string, tableName: string, rowId: any, query?: {
     ...
     */
        update: (orgs: string, projectName: string, tableName: string, rowId: any, data: object, query?: {
            /** To get Hidden Columns */
            getHiddenColumn?: boolean;
        }, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        delete: (orgs: string, projectName: string, tableName: string, rowId: any, query?: {
            /** To get Hidden Columns */
            getHiddenColumn?: boolean;
        }, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        exist: (orgs: string, projectName: string, tableName: string, rowId: any, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
        bulkCreate: (orgs: string, projectName: string, tableName: string, data: object[], params?: RequestParams) => Promise<{
            id?: string;
        }[]>;
        /**
     ...
     */
        bulkUpdate: (orgs: string, projectName: string, tableName: string, data: object[], params?: RequestParams) => Promise<number[]>;
        /**
     ...
     */
        bulkDelete: (orgs: string, projectName: string, tableName: string, data: object[], params?: RequestParams) => Promise<number[]>;
        /**
     ...
     */
        bulkUpdateAll: (orgs: string, projectName: string, tableName: string, data: object, query?: {
            where?: string;
            viewId?: string;
        }, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        bulkDeleteAll: (orgs: string, projectName: string, tableName: string, data: object, query?: {
            where?: string;
            viewId?: string;
        }, params?: RequestParams) => Promise<object[]>;
        /**
     ...
     */
        csvExport: (orgs: string, projectName: string, tableName: string, type: 'csv' | 'excel', params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        nestedList: (orgs: string, projectName: string, tableName: string, rowId: any, relationType: 'mm' | 'hm' | 'bt', columnName: string, query?: {
            /** @min 1 */
            limit?: number;
            /** @min 0 */
            offset?: number;
     ...
     */
        nestedAdd: (orgs: string, projectName: string, tableName: string, rowId: any, relationType: 'mm' | 'hm' | 'bt', columnName: string, refRowId: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        nestedRemove: (orgs: string, projectName: string, tableName: string, rowId: any, relationType: 'mm' | 'hm' | 'bt', columnName: string, refRowId: string, params?: RequestParams) => Promise<{
            /** @example The relation data has been deleted successfully */
            msg?: string;
        }>;
        /**
     ...
     */
        nestedChildrenExcludedList: (orgs: string, projectName: string, tableName: string, rowId: any, relationType: 'mm' | 'hm' | 'bt', columnName: string, query?: {
            /** @min 1 */
            limit?: number;
            /** @min 0 */
            offset?: number;
     ...
     */
        groupedDataList: (orgs: IdType, projectName: string, tableName: string, viewName: string, columnId: IdType, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        list: (orgs: string, projectName: string, tableName: string, viewName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        create: (orgs: string, projectName: string, tableName: string, viewName: string, data: object, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        findOne: (orgs: string, projectName: string, tableName: string, viewName: string, query?: {
            fields?: any[];
            sort?: any[];
            where?: string;
            /** Query params for nested data */
     ...
     */
        groupBy: (orgs: string, projectName: string, tableName: string, viewName: string, query?: {
            /** Column name of the column you want to group by, eg. `column_name=column1` */
            column_name?: string;
            sort?: any[];
            where?: string;
     ...
     */
        count: (orgs: string, projectName: string, tableName: string, viewName: string, query?: {
            where?: string;
            /** Query params for nested data */
            nested?: any;
        }, params?: RequestParams) => Promise<{
     ...
     */
        read: (orgs: string, projectName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        update: (orgs: string, projectName: string, tableName: string, viewName: string, rowId: any, data: object, params?: RequestParams) => Promise<object>;
        /**
     ...
     */
        delete: (orgs: string, projectName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<number>;
        /**
     * @description Check row with provided primary key exists or not
     *
     * @tags DB View Row
     ...
     */
        exist: (orgs: string, projectName: string, tableName: string, viewName: string, rowId: any, params?: RequestParams) => Promise<number>;
        /**
     * @description Export Table View Rows by CSV or Excel
     *
     * @tags DB View Row
     ...
     */
        export: (orgs: string, projectName: string, tableName: string, viewName: string, type: 'csv' | 'excel', params?: RequestParams) => Promise<any>;
    };
    public: {
        /**
     ...
     */
        dataNestedList: (sharedViewUuid: string, rowId: any, relationType: 'mm' | 'hm' | 'bt', columnName: string, query?: {
            /** Which fields to be shown */
            fields?: any[];
            /** The result will be sorted based on `sort` query */
            sort?: string[] | string;
     ...
     */
        csvExport: (sharedViewUuid: string, type: 'csv' | 'excel', params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        commentRow: (data: CommentReqType, params?: RequestParams) => Promise<AuditType>;
        /**
         ...
         * @response `200` `number` OK
         */
        commentUpdate: (auditId: string, data: CommentUpdateReqType, params?: RequestParams) => Promise<number>;
        /**
     ...
     */
         ...
         * @response `200` `any` OK
         */
        selectQuery: (data: any, params?: RequestParams) => Promise<any>;
        /**
     ...
     */
        status: (pluginTitle: string, params?: RequestParams) => Promise<boolean>;
        /**
     ...
     */
        list: (projectId: IdType, params?: RequestParams) => Promise<ApiTokenListType>;
        /**
     ...
     */
        create: (projectId: IdType, data: ApiTokenReqType, params?: RequestParams) => Promise<ApiTokenType>;
        /**
     ...
     */
        delete: (projectId: IdType, token: string, params?: RequestParams) => Promise<number>;
    };
    storage: {
        /**
